...
export const projects: Project[] = [
  ...
  },
  {
    ...
    image: "/projects/caselens/Intelix-Hero.png",
    gallery: [
      { label: "Workspace dashboard", src: "/projects/caselens/dashboard.png", kind: "desktop" },
      { label: "Legal matters list", src: "/projects/caselens/matters-list.png", kind: "desktop" },
      ...
      { label: "Legal-BERT named entity recognition", src: "/projects/caselens/entities.png", kind: "desktop" },
      { label: "Case timeline & key dates", src: "/projects/caselens/timeline.png", kind: "desktop" },
      { label: "AI Legal Counsel chat", src: "/projects/caselens/ai-counsel.png", kind: "desktop" },
      { label: "Contacts — clients, counsel & witnesses", src: "/projects/caselens/contacts.png", kind: "desktop" },
